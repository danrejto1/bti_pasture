...
meat_prod_global_adjusted <- read_csv(file =  "../data/clean_data/meat_prod_global_adjusted.csv")
milk_prod_global_adjusted <- read_csv(file =  "../data/clean_data/milk_prod_global_adjusted.csv")

stocks_global <- read_csv(file =  "../data/clean_data/cattle_stocks_global.csv")
