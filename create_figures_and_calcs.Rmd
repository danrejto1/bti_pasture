...
```{r Line Graph of pct change in beef and milk yields and stocking density globally}
p <- global_indices %>%
...
```{r Line Graph of index of global pasture, cattle meat production, and cattle milk production}
p <- global_indices %>%
