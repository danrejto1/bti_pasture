...
library(knitr)
opts_chunk$set(fig.width=10, fig.height=10, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide')
...
ggsave(filename = "outputs/tfig_7_annual_beef_milk_consumption_change.pdf", plot = p)
```
