...
## Pasture Area by Geographic Group
...
```
```{r Fig A6 - Graph Yield Slowdown in High Income Countries}
p <- pd %>% 
...
## Projections of future pasture and consumption
