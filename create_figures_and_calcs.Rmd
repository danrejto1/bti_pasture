...
p <- ggplot(pd, aes(x=year, y=tot, color=region)) +
  geom_line() +
  labs(x="", y = "Million metric tons", caption = "Data: FAO. 2018. The future of food and agriculture – Alternative pathways to 2050. Rome.\n Values are for 'Beef and veal' and 'Raw milk' FAO items", color = "Countries")+ 
  scale_color_manual(values = cols)+
