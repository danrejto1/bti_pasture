...
```{r Line Graph of pct change in beef and cattle milk yields and stocking density globally}
p <- global_indices %>%
...
```{r Line Graph of pct chnage in global pasture, beef production, and cattle milk production}
p <- global_indices %>%
...
- Globally, the number of cattle stocks per hectare has increased `r round(filter(global_indices, year==2016)$pct_chg_stocking-1,2)`% since 1961
